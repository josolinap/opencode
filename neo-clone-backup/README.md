...
### Available Skills (Phase 3 Enhanced)

The assistant now includes 7 built-in skills:
...
6. **web_search** 🔍 - Search the web, fact-check, find information
...
### Analytical Presets
- **🔍 fact_checking** - Designed for verification and accurate information
