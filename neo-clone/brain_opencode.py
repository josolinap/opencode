...
class ConversationHistory:
    ...
    def to_enhanced_list(self) -> List[Dict[str, Any]]:
        ...
        return [{
            ...
            "session_time": m.timestamp - self.session_start
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "user_messages": len([m for m in self._messages if m.role == "user"]),
            "assistant_messages": len([m for m in self._messages if m.role == "assistant"])
        }
...
class OpencodeBrain:
    ...
    def parse_intent(self, text: str) -> Dict[str, str]:
        ...
        # MiniMax Agent specific intents
    ...
    def route_to_skill(self, skill_name: str, text: str, context: Optional[Dict] = None) -> Dict:
        ...
        try:
            ...
            return {
                ...
                "output": result,
                "reasoning": f"Chose skill '{skill_name}' due to detected keywords and context analysis."
            }
    ...
    def show_available_models(self) -> str:
        ...
        for model in models[:10]:  # Limit display
            marker = "▶️ " if model == current else "  "
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        status = {
            ...
            "is_opencode_available": self.opencode_model is not None,
            "model_switches": self.model_switch_count,
            "conversation_stats": self.history.get_stats(),
            "available_skills": list(self.skills.skills.keys()),
            "config_source": "opencode" if self.opencode_model else "local"
        }
