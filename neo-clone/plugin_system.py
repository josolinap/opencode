...
class PluginManager:
    ...
    def _load_plugin_metadata(self, plugin_file: Path, plugin_name: str) -> Optional[PluginMetadata]:
        ...
        try:
            # Try to load metadata from file docstring or metadata file
    ...
    def _generate_plugin_template(self, plugin_name: str, plugin_type: str = "basic") -> str:
...
'''
    ...
    def _generate_metadata_template(self, plugin_name: str, plugin_type: str) -> Dict[str, Any]:
        ...
        return {
            "name": plugin_name,
            "version": "1.0.0",
            "description": f"Example {plugin_type} plugin for Neo-Clone",
            "author": "Your Name",
            "dependencies": [],
            "main_class": f"{plugin_name.replace('_', '').title()}Plugin"
        }
...
# Plugin decorators and utilities
...
# Example plugin loader for backward compatibility
