...
def main():
    ...
    # Import and inspect each skill module explicitly
    ...
    # For each module, look for classes that subclass BaseSkill
    ...
    # Instantiate SkillRegistry and show registered skills and internal mapping
    try:
        ...
        # Print registered skill objects types
