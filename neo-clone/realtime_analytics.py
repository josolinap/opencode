...
class RealTimeAnalytics:
    ...
    def add_alert_callback(self, callback: Callable[[PerformanceAlert], None]):
        ...
        self.alert_callbacks.append(callback)
        logger.info(f'Added alert callback (total: {len(self.alert_callbacks)})')
    ...
    def record_metric(self, metric_name: str, value: float, tags: Dict[str, str] = None):
        ...
        if metric_name == 'response_time':
            self.current_metrics['response_times'].append(value)
        elif metric_name == 'error':
            self.current_metrics['error_count'] += int(value)
        elif metric_name == 'request':
            self.current_metrics['total_requests'] += int(value)
        elif metric_name == 'model_switch':
            self.current_metrics['model_switches'] += int(value)
