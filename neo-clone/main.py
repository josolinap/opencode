...
def cli_mode(args=None, cfg=None):
    ...
    try:
        ...
        logger.info(f"Plugin system initialized with {len(plugin_manager.get_loaded_plugins())} plugins")
    except Exception as e:
    ...
    while True:
        try:
            ...
            if text.lower() == "skills":
                ...
                print(f"🛠️  Available skills ({len(skill_list)}):")
            ...
            if text.lower() == "presets" and preset_manager:
                ...
                print(f"⚙️  Available LLM Presets ({len(presets)}):")
